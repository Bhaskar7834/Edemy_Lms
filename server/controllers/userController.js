...
// Verify Stripe Payment (Production Ready)
export const verifyPayment = async (req, res) => {
    try {
        ...
        if (session.payment_status === 'paid') {
            ...
            // 2. Check if already enrolled (using String comparison for safety)
...
// Force Create User (Helper for localhost/Clerk issues)
